...
0. 移动端加载性能优化想法：
    ...
    * 按需加载：模块化的程度要高
        ...
        * 隐藏内容按需加载。这里配合一个**点击统计分析的方式最佳**，页面那些功能或者页面被点击的更多，那么就可以预加载这部分内容，而不需要点击之后才加载内容，[dieulot / instantclick](https://github.com/dieulot/instantclick/)
            * 如果可以做成按照点击统计的权重来判断预加载的策略分配，也是一个很有意思的事情
...
* 海豚：对，它还是一个Web UI自动化测试平台，专为移动端WebApp量身定做。[介绍文章](http://div.io/topic/1339) [示例版本](http://dolphin.duapp.com)
...
* **安全**
    0. [浅谈基于JavaScript的DDOS攻击](http://www.freebuf.com/news/66447.html)
